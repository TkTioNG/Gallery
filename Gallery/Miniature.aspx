<%@ Page Title="Miniature" MasterPageFile="~/Site1.Master" Language="C#" AutoEventWireup="true" CodeBehind="Miniature.aspx.cs" Inherits="Gallery.Miniature1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="body">
        ...
        <div>
            ...
            <div style="width: 100%; position: relative; text-align: center; margin-top: 10px; margin-bottom: 10px; color: darkslategrey;">
                ...
                Filter by : &nbsp; 
                    <asp:DropDownList ID="ddlFilter" OnSelectedIndexChanged="ddlFilter_SelectedIndexChanged" runat="server" AutoPostBack="True">
                        <asp:ListItem Value="figure">All</asp:ListItem>
                        <asp:ListItem Value="PVC figure">PVC figure</asp:ListItem>
                        <asp:ListItem Value="Nendoroid figure">Nendoroid figure</asp:ListItem>
                        <asp:ListItem Value="Gundam figure">Gundam figure</asp:ListItem>
                    </asp:DropDownList>
            </div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT P.ProductID, P.ProductName, P.SalerID, P.Image, P.Stock, P.Sales, P.CategoryID, P.Description, P.Price, U.UserName, C.CategoryName FROM Product AS P INNER JOIN Users AS U ON P.SalerID = U.UserID INNER JOIN Category AS C ON P.CategoryID = C.CategoryId WHERE (C.CategoryName LIKE '%figure%') ORDER BY P.ProductID DESC"></asp:SqlDataSource>
        </div>
        <!-- Main Content End -->
    </div>
    <!-- Body Content End -->
