...
namespace Gallery
{
    public partial class MyGalleryShowDown : System.Web.UI.Page
    {
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ClientScript.RegisterStartupScript(typeof(Page), "script", "alert(\'No image is selected.\');", true);
            }
            BindRepeater();
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string galleryName = lblGalleryName.Text;
            string image = (item.FindControl("GalleryImage") as Image).ImageUrl;

            string constr = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("DELETE FROM GalleryPhoto WHERE GalleryName = @GalleryName AND Image = @Image", con))
                {
                    cmd.Connection = con;
                    cmd.Parameters.AddWithValue("@GalleryName", galleryName);
        ...
        protected void btnDeleteAll_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("DELETE FROM GalleryPhoto WHERE GalleryName = @GalleryName", con))
                {
                    cmd.Connection = con;
                    cmd.Parameters.AddWithValue("@GalleryName", galleryName);
                    con.Open();
                ...
                using (SqlCommand cmd = new SqlCommand("DELETE FROM Gallery WHERE GalleryName = @GalleryName", con))
                {
                    cmd.Connection = con;
                    cmd.Parameters.AddWithValue("@GalleryName", galleryName);
                    con.Open();
