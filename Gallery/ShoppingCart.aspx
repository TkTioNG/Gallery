<%@ Page Title="Shopping Cart" MasterPageFile="~/Site1.Master" Language="C#" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="Gallery.ShoppingCart" %>
                                ...
                                <div style="width: 95%; border-bottom: 2px solid gray; padding-top: 25px; margin-left: 2.5%; min-height: 300px;">
                                    <div style="width: 100%; min-height: 220px;">
                                        ...
                                        <div style="float: right; display: inline-block; width: 68%; min-width: 320px; min-height: 180px; padding-left: 20px; padding-right: 5px; margin-top: 10px;">
                                            ...
                                            <table style="width: 100%; vertical-align: middle; line-height: 30px;">
                                                ...
                                                <tr>
                                                    <td style="width: 50%; max-width: 50%;">Quantity &emsp;&emsp; :&ensp;<asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("Quantity") %>'></asp:Label>
                                                        <asp:TextBox ID="txtQuantity" runat="server" Visible="false" Text='<%# Eval("Quantity") %>'></asp:TextBox>
                                                    </td>
                                                    <td style="width: 50%; max-width: 50%;">Total Price &emsp;&emsp;&ensp;:&ensp; RM&nbsp;<asp:Label ID="lblTotal" runat="server" Text='<%# Eval("Total") %>'></asp:Label>
                                                    </td>
                                                </tr>
                                    ...
                                    <div style="clear: both; margin-bottom: 25px; text-align: center;">
                                        <div style="display: inline-block; margin-top: 20px;">
                                            <asp:Button ID="btnCheckOut" CssClass="ctrlButton" runat="server" Text="Check Out" OnClick="btnCheckOut_Click" OnClientClick="return confirm('Do you wish to check out right now?')" />
